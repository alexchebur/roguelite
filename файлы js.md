...
<div id="game-layout">
    ...
    <div id="minimap-panel" class="panel">
     ...
     <!-- В index.html -->
     <footer class="panel" style="grid-column: 2 / 4; grid-row: 3; display: flex; align-items: center; justify-content: center; text-align: center; padding: 0 20px;">
         ...
         <!-- Кнопка отказа (скрыта по умолчанию) -->
         <div id="btn-abandon-quest" 
              style="display: none; color: #f85149; font-size: 11px; cursor: pointer; opacity: 0.6; transition: opacity 0.2s; user-select: none; margin-left: 15px;"
...
const BOSS_DATA = {
    ...
    syllables: {
        prefixes: ["Зул", "Мор", "Гар", "Тар", "Ксар", "Вул", "Нек", "Аз", "Иг", "Рак"],
        roots: ["го", "рак", "тар", "мун", "дор", "зул", "рак", "тул", "зар", "морг"],
        suffixes: ["гор", "акс", "ум", "иус", "ар", "он", "ат", "ус", "ор", "ак"]
    }
};
