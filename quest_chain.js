...
const QuestChainModule = (function() {
    ...
    const CHAIN_TEMPLATES = {
        FETCH: [
            "Хранители города {city} утратили артефакт: {item}. Разведчики донесли, что он в подземелье {location}. Найди его, и дальше пойдешь в {nextCity}.",
    ...
    const TURN_IN_TEMPLATES = {
        FETCH: [
            "Ты нашел {item}! Жители {city} вздохнули с облегчением. Теперь иди в {nextCity}, там тебя ждет новое задание.",
            "Отличная работа. Артефакт в целости. Твой путь теперь лежит в {nextCity}."
        ],
        HUNT: [
        ...
        EXPLORE: [
            "Твои карты и заметки бесценны. Новая тайна ждет тебя в {nextCity}. Спеши туда!"
        ],
        DIGGER: [
