...
const LoreModule = (function() {
    ...
    const BOOK_FRAGMENTS = [
        ...
        "Торговый договор: '50 мечей за 10000 золотых. Доставка в Северные Врата. Опасность пути оценивается как высокая.'",
    ...
    const RUMORS = [
        ...
        "Я видел, как огромный дракон пролетал над окрестностями.",
        "Не ходи на север, путник. Там вода в реках стала красной.",
        "Где-то на севере заколдованная твердыня выросла прямо из-под земли.",
        "Архивариус ищет тех, кто читал древние фолианты. Платят золотом.",
        "В лесах появились волки с горящими красными глазами.",
        "Торговцы шепчутся, что цены на зелья скоро упадут из-за чумы.",
        "Неизвестные армии тихо появляются и исчезают в разных местах.",
        "Говорят, на севере живет могущественный колдун.",
        "Один мой знакомый нашел карту, но сошел с ума, пытаясь её прочитать.",
        "Искатели приключений рассказывают, что подземелья прорастают вглубь, к кипящему дну мира."
    ];
