...
const DataModule = (function() {
    ...
    const ENEMY_TYPES = [
        ...
        { name: "Крыса", char: "r", color: "#795548", hp: [8, 12], atk: [1, 1], def: [0, 0] },      // Урон 0-1 (безопасно)
        { name: "Гоблин", char: "g", color: "#4CAF50", hp: [12, 18], atk: [1, 2], def: [0, 1] },    // Урон 1-3 (легко)
        { name: "Волк", char: "w", color: "#9E9E9E", hp: [15, 22], atk: [2, 3], def: [0, 1] },      // Урон 2-4 (средне)
        
        // === УРОВЕНЬ 4-6: Первая опасность ===
        // Появляются враги с защитой или высоким уроном.
        { name: "Бандит", char: "b", color: "#FF9800", hp: [25, 35], atk: [3, 5], def: [1, 2] },    // Танкует немного
        { name: "Скелет", char: "s", color: "#B0BEC5", hp: [20, 30], atk: [3, 6], def: [1, 2] },    // Бьет больнее
        { name: "Слизень", char: "j", color: "#00BCD4", hp: [30, 45], atk: [2, 3], def: [3, 5] },   // Почти не получает урон без хорошего оружия
        { name: "Орк-разведчик", char: "O", color: "#8BC34A", hp: [35, 50], atk: [4, 7], def: [2, 3] }, // Опасен в группе
        ...
        { name: "Тролль", char: "T", color: "#4CAF50", hp: [80, 120], atk: [10, 15], def: [2, 3] }, // Регенерация (в будущем), сейчас просто танк
