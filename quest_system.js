...
const QuestSystemModule = (function() {
    ...
    const QUEST_TEMPLATES = {
        ...
        HUNT: [
            "Чудовища, которых называют {enemy}, расплодились на нижних уровнях подземелья {location} (глубина {depth}+). Убей {count} штук, и город будет в безопасности. Награда: {gold} золотых.",
        ...
        DIGGER: [
            ...
            "Говорят, на {depth} уровне в подземелье {location} есть залежи золота. Доберись туда и проверь. Плачу {gold} монет."
        ],
        COLLECT: [
            "Мне нужно {count} шт. предмета '{item}' для экспериментов. Ищи в подземелье {location} (глубина {depth}+). Награда: {gold} золотых.",
            "Собери {count} экземпляров предмета '{item}' в подземелье {location}. Заплату {gold} монет."
        ],
        BOUNTY: [
            "Голова монстра, известного как {enemy}, стоит дорого. Убей {count} штук в любом подземелье. Награда: {gold} золотых.",
            "Эти твари, которых называют ({enemy}), стали слишком наглыми. Истреби {count} особей где бы ты их ни нашел. Плачу {gold}."
        ],
        SCHOLAR: [
            "Архивариус ищет затерянные знания. Прочитай {count} древних книг, которые найдешь. Награда: {gold} золотых."
        ],
        // Внутри QUEST_TEMPLATES в quest_system.js
        BOSS_HUNT: [
            "Гильдия охотников объявляет чрезвычайную награду! В подземелье {location} обосновался ужасающий монстр: {enemy}. Ликвидируйте монстра, пока он не уничтожил ближайшие поселения. Награда: {gold} золотых.",
